...
namespace DewDrop.Graphics
{
    ...
    public class IndexedColorGraphic : Graphic
    {
        ...
        // shaaaaaaaaaaaaader!
        private static readonly Shader INDEXED_COLOR_SHADER = new Shader(EmbeddedResourcesHandler.GetResourceStream("pal.vert"), null, EmbeddedResourcesHandler.GetResourceStream("pal.frag"));
        ...
        public void SetSprite(string name, bool reset)
        {
            ...
            this.Size = new Vector2(sprite.TextureRect.Width, sprite.TextureRect.Height);
