...
namespace Californium
{
    ...
    public class SpriteBatch
    {
        ...
        private static TextureSheet Sheet
        {
            get { return sheet ??= new TextureSheet(512); }
        }
    ...
    internal class TextureSheet
    {
        struct TextureInfo
        {
            ...
            {
                return (subrect.Left | ((subrect.Top & 0xFFF) << 8) | ((subrect.Width & 0xFF) << 16) | ((subrect.Height & 0xFF) << 24)) ^ texture.CPointer.GetHashCode();
            }
        }
