...
namespace Violet.GUI
{
    public class TextRegion : Renderable
    {
        ...
        public TextRegion(Vector2 position, int depth, FontData font, string text) : this(position, depth, font, (text != null) ? text : string.Empty, 0, (text != null) ? text.Length : 0) { }

        public TextRegion(Vector2 position, int depth, FontData font, string text, int index, int length)
        {
