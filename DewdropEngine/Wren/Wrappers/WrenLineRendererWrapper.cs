...
[WrenMethod("SetPositionA", "positionA")]
public void SetPositionA(WrenVM vm)
{
vm.EnsureSlots(1);
Stored.SetPositionA(vm.GetSlotForeign<WrenVector2Wrapper>(1).Vector);
}

[WrenMethod("SetPositionB", "positionB")]
public void SetPositionB(WrenVM vm)
{
vm.EnsureSlots(1);
Stored.SetPositionB(vm.GetSlotForeign<WrenVector2Wrapper>(1).Vector);
}
